...
type ButtonSizeTypes = 'extra-small' | 'small' | 'medium';

type ButtonCategoryTypes = 'primary' | 'secondary' | 'tertiary';
    ...
    <Pressable
      ...
      style={({pressed}) => [
        ...
        props.title
          ...
          : {padding: props.buttonCategory === 'tertiary' ? 10 : 8},
        props.style,
        props.disabled
          ? obtainButtonCategoryStyleDisabled(props.buttonCategory)
          : null,
      ...
      <View style={[styles().viewButton, props.styleView]}>
        {props.icon && (
          <Icon
            ...
            style={[
              ...
              props.buttonCategory === 'tertiary'
                ? {tintColor: theme.colors.gray_700}
                : {tintColor: theme.colors.primary_800},
              props.disabled &&
              (!props.buttonCategory || props.buttonCategory === 'primary')
                ? {tintColor: theme.colors.gray_500}
                : null,
              props.disabled &&
              (props.buttonCategory === 'secondary' ||
                props.buttonCategory === 'tertiary')
        ...
        {props.title ? (
          <Label
            style={[
              obtainTextCategoryStyleDefault(props.buttonCategory),
