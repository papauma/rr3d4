...
import FavoritesStops from '@src/components/features/favorites/FavoritesStops';
...
export default function FavoritesScreen() {
  ...
  const favoritesSections: Array<ITabSection> = [
    ...
    }, 
    {
        ...
        content: (<FavoritesLines lines={/* favorites.lines */[1652, 796, 1405]}/>),
    }
  ]
    ...
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{flex: 1, paddingBottom: 16}}>
        ...
        <TripleTab
            ...
            styleContainer={{backgroundColor: theme.colors.white, marginHorizontal: 16}}
        />
      </View>
    </SafeAreaView>
  );
